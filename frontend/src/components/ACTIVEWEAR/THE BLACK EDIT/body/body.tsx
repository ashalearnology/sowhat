...
const Shop_carts = () => {
  const Cartsdetails = [
    ...
    },
    {
      ...
      imag2: 'https://sowhat.global/cdn/shop/files/aqw4_1080x.png?v=1684483043',
    ...
    {
      imag1: 'https://sowhat.global/cdn/shop/files/ac6_1080x.png?v=1683798644',
      imag2:
    ...
    },
    {
      ...
      imag2: 'https://sowhat.global/cdn/shop/files/aqw2_1080x.png?v=1684483009',
